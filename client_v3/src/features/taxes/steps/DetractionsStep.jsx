      ...
      <CardContent>
        <div className="space-y-6">
          ...
          <div className="bg-blue-50 p-4 rounded-lg space-y-3">
            <h4 className="font-medium text-blue-900">Fascia 1: Reddito fino a €15.000</h4>
          ...
          <div className="bg-green-50 p-4 rounded-lg space-y-3">
            <h4 className="font-medium text-green-900">Fascia 2: Reddito da €15.001 a €28.000</h4>
          ...
          <div className="bg-yellow-50 p-4 rounded-lg space-y-3">
            <h4 className="font-medium text-yellow-900">Fascia 3: Reddito da €28.001 a €50.000</h4>
