...
export default function MunicipalAdditionalsUpload() {
  ...
  const handleUpload = async () => {
    ...
    fd.append('file', file);
    try {
      const res = await axios.post('/api/taxrates/municipal-additionals/upload', fd, { headers: { 'Content-Type': 'multipart/form-data' } });
      ...
      <div className="import-wizard-header">
        <div className="header-content">
          <div className="header-title">
            ...
            <div>
              <h1>Carica Addizionali Comunali</h1>
              <p>CSV in italiano: colonne anno;regione;comune;tipo(fissa/progressiva);aliquota;min;max</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="upload-step-container">
        <div className="upload-main-content">
          ...
          <div className="file-selector">
            <input id="municipal-add-file" type="file" accept=".csv,.xlsx,.xls" className="file-input-hidden" onChange={onSelect} />
            <label htmlFor="municipal-add-file" className="file-selector-label">
              {!file ? (
          ...
          <div className="upload-actions">
            <button className="btn btn-primary btn-analyze" disabled={!file || loading} onClick={handleUpload}>
              {loading ? (<><RefreshCw size={16} className="animate-spin" /> Caricamento...</>) : 'Carica Addizionali Comunali'}
            </button>
          </div>
        ...
        <div className="help-sidebar">
            ...
            <div className="help-content">
              <div className="help-section">
                ...
                <ul>
                  ...
                  <li><strong>comune</strong>: es. Pesaro</li>
                  <li><strong>tipo</strong>: <em>fissa</em> oppure <em>progressiva</em></li>
                  <li><strong>aliquota</strong>: es. 0,80 (usa la virgola)</li>
                  <li><strong>min</strong> (solo progressiva)</li>
                  <li><strong>max</strong> (solo progressiva, opzionale)</li>
                </ul>
              </div>
              <div className="help-section">
                <h4 style={{ display:'flex', alignItems:'center', gap:6 }}><MapPin size={16} /> Esempi righe</h4>
                <ul>
                  <li><code>2025;Marche;Pesaro;fissa;0,80;;</code></li>
                  <li><code>2025;Marche;Pesaro;progressiva;0,60;0;15000</code></li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div className="help-card">
            ...
            <div className="help-content">
              ...
              <p>
                <a href="/examples/tax/municipal-additionals-example-italian.csv" download className="btn btn-primary">
