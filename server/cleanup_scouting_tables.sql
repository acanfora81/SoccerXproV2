-- ===============================================================
-- 🗑️ SCRIPT DI PULIZIA TABELLE SCOUTING ESISTENTI
-- ===============================================================
-- 
...
-- Tabelle scouting legacy (schema v1)
DROP TABLE IF EXISTS scouting_tag_link CASCADE;
DROP TABLE IF EXISTS scouting_tag CASCADE;
DROP TABLE IF EXISTS scouting_scout_region CASCADE;
DROP TABLE IF EXISTS scouting_region CASCADE;
DROP TABLE IF EXISTS scouting_review CASCADE;
DROP TABLE IF EXISTS scouting_media CASCADE;
DROP TABLE IF EXISTS scouting_followup CASCADE;
DROP TABLE IF EXISTS scouting_assignment CASCADE;
DROP TABLE IF EXISTS scouting_report_score CASCADE;
DROP TABLE IF EXISTS scouting_report CASCADE;
DROP TABLE IF EXISTS scouting_session CASCADE;
DROP TABLE IF EXISTS scouting_match CASCADE;
DROP TABLE IF EXISTS scouting_rubric_criterion CASCADE;
DROP TABLE IF EXISTS scouting_rubric CASCADE;
DROP TABLE IF EXISTS scouting_scout CASCADE;
