-- ===============================================================
-- 🧮 FISCAL SETUP V2 - MIGRAZIONE DEFINITIVA
-- Script basato sulla struttura REALE della tabella tax_rates
-- ===============================================================
...
-- ===============================================================
-- 3️⃣ MIGRAZIONE DATI DA tax_rates (SNAKE_CASE)
-- ===============================================================

-- Migra dati da TaxRate legacy a tax_rates_v2 usando la struttura REALE (snake_case)
